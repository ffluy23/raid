...
export const moves = {
  ...
  "방전":       { power: 40, type: "전기", accuracy: 100, alwaysHit: false, aoe: true,  effect: { chance: 0.3, volatile: "풀죽음" } },
  ...
  "얼어붙은바람":     { power: 40, type: "얼음", accuracy: 95, alwaysHit: false, targetSelf: false, effect: null, rank: { targetSpd: -1, turns: 1 } },
  ...
  "매지컬샤인": { power: 50, type: "페어리", accuracy: 100, alwaysHit: false, aoe: true,  effect: null },
